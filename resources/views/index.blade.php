...
@section('content')
    ...
    <div class="gallery-section">
        <div class="gallery">
            ...
            <div class="gs-item grid-wide set-bg" data-setbg="{{asset('assets/img/gallery/gallery-1.jpg')}}">
                <a href="{{asset('assets/img/gallery/gallery-1.jpg')}}" class="thumb-icon image-popup"><i
                        class="fa fa-picture-o"></i></a>
            </div>
            <div class="gs-item set-bg" data-setbg="{{asset('assets/img/gallery/gallery-2.jpg')}}">
                <a href="{{asset('assets/img/gallery/gallery-2.jpg')}}" class="thumb-icon image-popup"><i
                        class="fa fa-picture-o"></i></a>
            </div>
            <div class="gs-item set-bg" data-setbg="{{asset('assets/img/gallery/gallery-3.jpg')}}">
                <a href="{{asset('assets/img/gallery/gallery-3.jpg')}}" class="thumb-icon image-popup"><i
                        class="fa fa-picture-o"></i></a>
            </div>
            <div class="gs-item set-bg" data-setbg="{{asset('assets/img/gallery/gallery-4.jpg')}}">
                <a href="{{asset('assets/img/gallery/gallery-4.jpg')}}" class="thumb-icon image-popup"><i
                        class="fa fa-picture-o"></i></a>
            </div>
            <div class="gs-item set-bg" data-setbg="{{asset('assets/img/gallery/gallery-5.jpg')}}">
                <a href="{{asset('assets/img/gallery/gallery-5.jpg')}}" class="thumb-icon image-popup"><i
                        class="fa fa-picture-o"></i></a>
            </div>
            <div class="gs-item grid-wide set-bg" data-setbg="img/gallery/gallery-6.jpg">
                <a href="{{asset('assets/img/gallery/gallery-6.jpg')}}" class="thumb-icon image-popup"><i
                        class="fa fa-picture-o"></i></a>
            </div>
        </div>
    </div>
    ...
    <section class="team-section spad">
        <div class="container">
            ...
            <div class="row">
                <div class="ts-slider owl-carousel w-100">
                    <div class="col-lg-10">
